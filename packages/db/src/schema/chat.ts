...
import { conversationTypeEnum, messageTypeEnum, participantRoleEnum } from "./enums";
...
export const participant = pgTable(
  "participant",
  {
    ...
    updatedAt: timestamp("updated_at")
      ...
      .$onUpdate(() => /* @__PURE__ */ new Date())
      .notNull(),
    lastDeliveredSequence: integer("last_delivered_sequence").default(0).notNull(),
    lastSeenSequence: integer("last_seen_sequence").default(0).notNull(),
  },
  (table) => [
